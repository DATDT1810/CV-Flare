(function ($) {
    ...
    // Mở hộp chọn tệp khi nhấp vào nút
    chooseFileButton.addEventListener('click', (e) => {
        e.stopPropagation(); // Ngăn sự kiện click trên toàn bộ div
        fileInput.click();
    });

    // Cho phép kéo và thả tệp
    ...
    dropZone.addEventListener('drop', (e) => {
        ...
        // Xử lý các tệp đã thả vào
        console.log(files);
    });

    // Khi có thay đổi trong input tệp
